        ...
        if (menu_num == 0) {
            ...
            if (game_num == 0) {
                ...
                while (1) {
                    ...
                    if (key == k_1) {
                        if (!block_used[0]) {
                            if (input_plusPoint(m_board, c_board, f_block)) {
                                total_point += count_block_cells(f_block); // 블럭 칸 수만큼 점수
                                block_used[0] = true;
                                main_block(f_block);
                            }
                        }
                        ...
                        if (!block_used[1]) {
                            if (input_plusPoint(m_board, c_board, s_block)) {
                        ...
                        if (!block_used[2]) {
                            if (input_plusPoint(m_board, c_board, t_block)) {
